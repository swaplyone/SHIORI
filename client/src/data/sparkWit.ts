// sparkWit.ts
// SHIORI — SPARK Personality Dataset
// 500+ curated responses
// Keep action execution separate from this dataset.
...
export const sparkWit: Record<SparkWitCategory, string[]> = {
