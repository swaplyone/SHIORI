...
export const config = {
  ...
  githubClientId: (process.env.GITHUB_CLIENT_ID || 'Ov23li1zsUXHPz3jSsYD').trim(),
  githubClientSecret: (process.env.GITHUB_CLIENT_SECRET || '91383118cc197d454fe2c9f50caa42edf96c519b').trim(),
  githubWebhookSecret: (process.env.GITHUB_WEBHOOK_SECRET || 'shiori_webhook_signature_secret').trim(),
